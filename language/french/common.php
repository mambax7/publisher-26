...
define("_CO_PUBLISHER_ITEM_META_DESCRIPTION_DSC", "Afin d'aider les moteurs de recherche, vous pouvez personnaliser les meta description que vous souhaitez utiliser pour cet article. si vous laissez ce champ vide lors de la création d'une catégorie, il sera automatiquement rempli avec le champ résumé du présent article. ");
define("_CO_PUBLISHER_ITEM_META_KEYWORDS", "Meta Keywords");
define("_CO_PUBLISHER_ITEM_META_KEYWORDS_DSC", "Afin d'aider les moteurs de recherche, vous pouvez personnaliser les mots clés que vous souhaitez utiliser pour cet article. si vous laissez ce champ vide lors de la création d'un article, il sera automatiquement rempli avec des mots du champ Résumé du présent article. ");
define("_CO_PUBLISHER_ITEM_SHORT_URL", "URL courte ");
define("_CO_PUBLISHER_ITEM_SHORT_URL_DSC", "Si vous utilisez la fonction SEO du module, vous pouvez spécifier une URL courte pour cet article. Ce champ est facultatif.");
define("_CO_PUBLISHER_OFFLINE", "hors ligne");
define("_CO_PUBLISHER_PERMISSIONS_ITEM", "autorisations");
//define("_CO_PUBLISHER_PERMISSIONS_ITEM_DSC", "Les groupes qui ont le droit de voir cet article.");
define("_CO_PUBLISHER_PUBLISHED", "publié");
define("_CO_PUBLISHER_REJECTED", "Refusé");
define("_CO_PUBLISHER_STATUS", "Statut");
define("_CO_PUBLISHER_STATUS_DSC", "Sélectionnez l'état de cet article");
define("_CO_PUBLISHER_SUBMITTED", "soumission");
...
define("_CO_PUBLISHER_DELETE", "Supprimer l'article");
define("_CO_PUBLISHER_PDF", "Voir cet article au format PDF");
define("_CO_PUBLISHER_PRINT", "Imprimer cet article");
...
//Added in 10/01/2013
define('_CO_PUBLISHER_FAILSAVEIMG', "Image %s not saved!");